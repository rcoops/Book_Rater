 ...
 */
class Version20180329121917 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__books AS SELECT id, title, isbn, isbn_13, publisher, publish_date, edition, average_rating FROM books');
        $this->addSql('DROP TABLE books');
        $this->addSql('CREATE TABLE books (id INTEGER NOT NULL, title VARCHAR(255) NOT NULL COLLATE BINARY, isbn VARCHAR(15) NOT NULL COLLATE BINARY, isbn_13 VARCHAR(15) DEFAULT NULL COLLATE BINARY, publisher VARCHAR(255) DEFAULT NULL COLLATE BINARY, publish_date DATETIME DEFAULT NULL, edition INTEGER DEFAULT NULL, average_rating INTEGER DEFAULT NULL, google_books_id VARCHAR(255) DEFAULT NULL, google_books_rating INTEGER DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO books (id, title, isbn, isbn_13, publisher, publish_date, edition, average_rating) SELECT id, title, isbn, isbn_13, publisher, publish_date, edition, average_rating FROM __temp__books');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__books AS SELECT id, title, isbn, isbn_13, publisher, publish_date, edition, average_rating FROM books');
        $this->addSql('DROP TABLE books');
        $this->addSql('CREATE TABLE books (id INTEGER NOT NULL, title VARCHAR(255) NOT NULL, isbn VARCHAR(15) NOT NULL, isbn_13 VARCHAR(15) DEFAULT NULL, publisher VARCHAR(255) DEFAULT NULL, publish_date DATETIME DEFAULT NULL, edition INTEGER DEFAULT NULL, average_rating INTEGER DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO books (id, title, isbn, isbn_13, publisher, publish_date, edition, average_rating) SELECT id, title, isbn, isbn_13, publisher, publish_date, edition, average_rating FROM __temp__books');
        $this->addSql('DROP TABLE __temp__books');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_4A1B2A92CC1CF4E6 ON books (isbn)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_4A1B2A9228920213 ON books (isbn_13)');
